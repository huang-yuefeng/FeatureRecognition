...
class Align():
    ...
    def affine_matrix(self, kp_s, kp_t, fit_pos):
        ...
        print ('matched source ',kp_s.shape)
        print ('matched target  ',kp_t.shape)
        ...
        print ('inliers source ',kp_s.shape)
        print ('inliers target  ',kp_t.shape)
    ...
    def warp_image(self, source, target, M):
        ...
        cv2.imwrite('./img_merge.jpg',merge)
    ...
    def align_image(self):
        ...
        print ('sift source ',kp_s.shape, desc_s.shape)
        print ('sift target  ',kp_t.shape, desc_t.shape)
